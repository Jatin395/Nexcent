...
function Side2() {
    ...
    return (
        <>
            <div className="flex justify-evenly mt-12 flex-col gap-4 items-center md:flex-row p-4" id='pro'>
                ...
                <motion.div className="p-4 w-1/2" initial='hidden' whileInView={'visible'} variants={RightVarient} viewport={{once:true}}>
                    <h1 className='text-3xl mb-6 text-center md:text-left'>How to design your site  footer like  <br />We did</h1>
                    ...
                    <div className="flex items-center justify-center md:justify-start">
                        <button className='mt-6 text-center bg-green-500 text-white rounded-sm w-40 hover:text-green-400 hover:bg-white hover:border border-gray-400 h-12'>Learn More</button>
                    </div>
                </motion.div>
